...
<div class="wrapper d-flex align-items-center">
	<div class="d-flex justify-content-around w-100">
		<div id="tag-cloud-container-1" class="tag-cloud-container d-flex flex-column align-items-center justify-content-between p-5">
			...
			<div id="tag-cloud-1" class="tag-cloud"></div>
		</div>

		<div id="tag-cloud-container-2" class="tag-cloud-container d-flex flex-column align-items-center justify-content-between p-5">
			<div class="input-group date" data-provide="datepicker">
				<div class="form-group">
			...
			<div id="tag-cloud-2" class="tag-cloud"></div>
		</div>
	</div>
</div>